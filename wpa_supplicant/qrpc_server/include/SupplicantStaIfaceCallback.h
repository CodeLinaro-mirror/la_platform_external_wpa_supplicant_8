...
public:
	...
	::ndk::ScopedAStatus onPmkCacheAdded(int64_t in_expirationTimeInSec, const std::vector<uint8_t>& in_serializedEntry) __attribute__((deprecated("use onPmkSaCacheAdded() instead.")));
	::ndk::ScopedAStatus onStateChanged(::aidl::android::hardware::wifi::supplicant::StaIfaceCallbackState in_newState, const std::vector<uint8_t>& in_bssid, int32_t in_id, const std::vector<uint8_t>& in_ssid, bool in_filsHlpSent) __attribute__((deprecated("This callback is deprecated from AIDL v2, newer HAL should call onSupplicantStateChanged()")));
	...
	::ndk::ScopedAStatus onMloLinksInfoChanged(::aidl::android::hardware::wifi::supplicant::ISupplicantStaIfaceCallback::MloLinkInfoChangeReason in_reason) override;
	::ndk::ScopedAStatus onDppConfigReceived(const ::aidl::android::hardware::wifi::supplicant::DppConfigurationData& in_configData) override;
	::ndk::ScopedAStatus onDppConnectionStatusResultSent(::aidl::android::hardware::wifi::supplicant::DppStatusErrorCode in_code) override;
	::ndk::ScopedAStatus onBssFrequencyChanged(int32_t in_frequencyMhz) override;
	::ndk::ScopedAStatus onSupplicantStateChanged(const ::aidl::android::hardware::wifi::supplicant::SupplicantStateChangeData& in_stateChangeData) override;
	::ndk::ScopedAStatus onQosPolicyResponseForScs(const std::vector<::aidl::android::hardware::wifi::supplicant::QosPolicyScsResponseStatus>& in_qosPolicyScsResponseStatus) override;
