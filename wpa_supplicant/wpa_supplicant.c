                                   ...
                                   int obss_scan, bool is_6ghz)
{
  ...
  int i, res;
  unsigned int j;
  static const int ht40plus_5ghz[] = {36,  44,  52,  60,  100, 108, 116, 124,
  ...
  if (!freq->ht_enabled && !is_6ghz) return;
...
static bool ibss_mesh_select_80_160mhz(struct wpa_supplicant *wpa_s,
  ...
  if ((mode->eht_capab[ieee80211_mode]
      ...
      is_6ghz && ssid->max_oper_chwidth == CONF_OPER_CHWIDTH_320MHZ &&
...
int get_shared_radio_freqs_data(struct wpa_supplicant *wpa_s,
  ...
  dl_list_for_each(ifs, &wpa_s->radio->ifaces, struct wpa_supplicant,
    ...
    if (!ifs->current_ssid || (!ifs->assoc_freq && !ifs->valid_links)) continue;
    ...
    if (i == idx) freqs_data[idx++].freq = freqs[j];
